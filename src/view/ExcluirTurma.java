...
public class ExcluirTurma extends JFrame {
	...
	public ExcluirTurma() {
		...
		//criando o frame
			...
			jf.getContentPane().setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		//configurando o frame
			...
			lblNome.setBounds(184, 107, 16, 14);
			...
			ExcluirBTT.setBounds(336, 104, 89, 23);
