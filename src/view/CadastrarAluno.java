...
public class CadastrarAluno extends JFrame {
	...
	public CadastrarAluno() {
		...
		//configurando o frame
			...
			textIdade.setBounds(205, 129, 121, 20);
			...
			EnviarBTT.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					resposta.setText("Aluno Criado");
				}
			});
			EnviarBTT.setBounds(292, 199, 89, 23);
			jf.getContentPane().add(EnviarBTT);
			
			textTurma = new JTextField();
			textTurma.setFont(new Font("Tahoma", Font.PLAIN, 12));
			textTurma.setBounds(205, 160, 121, 20);
			jf.getContentPane().add(textTurma);
			textTurma.setColumns(10);
			
			
			JLabel lblNewLabel_1_1_1 = new JLabel("Turma:");
			lblNewLabel_1_1_1.setBounds(160, 157, 40, 14);
